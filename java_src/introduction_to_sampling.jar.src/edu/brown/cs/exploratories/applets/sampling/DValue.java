  ...
  public void draw(Graphics paramGraphics)
  {
    if (this.is_visible)
    {
      ...
      if ((this.mouse_over) && (this.is_active)) {
        paramGraphics.setColor(this.active_box_color);
      } else {
        paramGraphics.setColor(this.box_color);
      }
      paramGraphics.fillRect(i - 3, j - 3, 6, 6);
    }
  }
...
/* Location:              /Users/masonbartle/Downloads/introduction_to_sampling.jar!/edu/brown/cs/exploratories/applets/sampling/DValue.class
