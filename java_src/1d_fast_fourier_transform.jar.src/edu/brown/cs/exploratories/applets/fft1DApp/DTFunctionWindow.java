  ...
  implements Serializable, ComponentListener, MouseListener, MouseMotionListener
{
  ...
  public static final int NUM_VALUES = 256;
  ...
  private void realloc()
  {
    ...
    for (int n = 0; n < 256; n++) {
      this.values_[n].setX(Math.round((float)(n * (this.chart_width / 255.0D))));
    }
  }
...
/* Location:              /Users/masonbartle/Downloads/1d_fast_fourier_transform.jar!/edu/brown/cs/exploratories/applets/fft1DApp/DTFunctionWindow.class
